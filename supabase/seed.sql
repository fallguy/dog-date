...
insert into public.dogs (owner_id, name, breed, size, energy, tags, notes, primary_photo_url, birthdate) values
  ...
  ('11111111-1111-1111-1111-111111111110', 'Snickerdoodle Maximillian',    'Catahoula Leopard Dog',         'Large',  'High',  ARRAY['needs a job','vocalizes opinions','herder'],       'Wants to herd you, the cat, and the sofa. Has goals. Has feelings about your goals.', 'https://images.unsplash.com/photo-1568393691080-bbf3a5e09d05?w=800&q=80', (now() - interval '4 years')::date),
